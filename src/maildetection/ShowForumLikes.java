...
public class ShowForumLikes extends javax.swing.JFrame {
frmConnection frm=new frmConnection();
Statement st=null;
ResultSet rs=null;
String[][] rows;
int i=0;
String[] columns=new String[]{"S.No.","User Names"};

    DefaultTableModel tableData;
    
    
    public ShowForumLikes(int mid) {
        initComponents();
        ...
        try
        {
            ...
            jTable1.getModel();
            rs=st.executeQuery("select * from forum_likes where msg_id="+mid);
            while(rs.next())
            {
                i++;
                
                Object[] x={i,rs.getString("uname")};
                tableData.addRow(x);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("user forum likes");
        jPanel1.add(jLabel1);
