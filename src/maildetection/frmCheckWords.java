...
public class frmCheckWords extends javax.swing.JFrame {
frmConnection frm=new frmConnection();
Statement st=null;
ResultSet rs=null;
String[][] rows;
int i=0;
String[] columns=new String[]{"S.No.","Words"};
    ...
    private void initComponents() {
        ...
        setTitle("Suspicious Data Dictionary");

        jPanel1.setBackground(new java.awt.Color(255, 204, 51));
        jPanel1.setLayout(null);

        jLabel1.setFont(new java.awt.Font("Algerian", 0, 18)); // NOI18N
        jLabel1.setText("Suspicious Data dictionary");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(190, 30, 270, 24);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        {
            String str=jTable1.getModel().getValueAt(jTable1.getSelectedRow(),1).toString();
        try
        {
            st=frm.getCon().createStatement();
            st.execute("delete from dataset where words='"+str+"'");
            JOptionPane.showMessageDialog(rootPane, "Successfully Deletion of Suspicious Words From Data Dictionary");
